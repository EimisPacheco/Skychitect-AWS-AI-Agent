# Skyrchitect AI - AWS Deployment Infrastructure
...
# S3 Bucket for Architecture Diagrams Storage
resource "aws_s3_bucket" "diagrams" {
  bucket = "${var.project_name}-diagrams-${var.environment}"

  tags = {
    Name        = "Skyrchitect Diagrams"
    Environment = var.environment
    Project     = var.project_name
  }
}
